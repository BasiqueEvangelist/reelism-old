...
public class ReeItems {
    ...
    public static final BattleAxeItem WOODEN_BATTLE_AXE = new BattleAxeItem(ToolMaterials.WOOD, 6.0F, -3.2F, new FabricItemSettings().group(ItemGroup.COMBAT));
    public static final BattleAxeItem STONE_BATTLE_AXE = new BattleAxeItem(ToolMaterials.STONE, 7.0F, -3.2F, new FabricItemSettings().group(ItemGroup.COMBAT));
    public static final BattleAxeItem GOLDEN_BATTLE_AXE = new BattleAxeItem(ToolMaterials.GOLD, 6.0F, -3.0F, new FabricItemSettings().group(ItemGroup.COMBAT));
    ...
    public static final BattleAxeItem DIAMOND_BATTLE_AXE = new BattleAxeItem(ToolMaterials.DIAMOND, 5.0F, -3.0F, new FabricItemSettings().group(ItemGroup.COMBAT));
